...
public abstract class TeamGame extends Game implements Listener {
	...
	public Location getSpawnLocation(Player player){
		Team team = this.getTeam(player.getDisplayName());
	...
	public Team getTeam(String displayName) {
	...
	public boolean playerDamagePlayer(Player attacker, Player victim) {
		Team team = getTeam(attacker.getDisplayName());
		
		if (team.allowFriendlyFire())
			return true;
		
		return (team.hasEntry(victim.getDisplayName()));
	}
