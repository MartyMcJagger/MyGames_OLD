...
import xenar47.bukkit.mygames.classes.PlayerClass;
...
public abstract class Game implements IGame {
	...
	private ArrayList<GameModule> modules = new ArrayList<GameModule>();
...
//		secsPerTick = getSecsPerTick();
	...
	public ArrayList<GameModule> getGameModules() {
		return modules;
	}
	...
	public void joinGame(Player player) {
		...
		for (GameModule module : modules)
			module.onPlayerJoin(player.getUniqueId());
	}
